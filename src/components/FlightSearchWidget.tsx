...
export default function FlightSearchWidget() {
  ...
  const search = () => {
    ...
    window.open(`https://wa.me/18299952995?text=${encodeURIComponent(msg)}`, '_blank');
  };
  ...
  const handleServiceTab = (tab: ServiceTab) => {
    if (tab !== 'vuelos') {
      ...
      window.open(`https://wa.me/18299952995?text=${encodeURIComponent(`Hola! Me interesa información sobre ${labels[tab]}.`)}`, '_blank');
    }
    setServiceTab(tab);
  };
