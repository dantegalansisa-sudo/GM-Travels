      ...
      <div className="privacy-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="privacy-modal__content">
          <section>
            ...
            <p>
              GM Travels recopila información personal que usted nos proporciona voluntariamente al contactarnos
          ...
          <section>
            ...
            <ul>
              <li>WhatsApp: 829-995-2995</li>
              <li>Dirección: Calle Palermo 14, Urbanización Italia, Edificio Gomed, Santo Domingo</li>
            </ul>
          </section>
