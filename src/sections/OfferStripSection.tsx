      ...
      <div className="section-container">
        <div className="offer-strip__header">
          ...
          <a
            ...
            href="https://wa.me/18299952995?text=Hola!%20Quiero%20ver%20todas%20las%20ofertas%20de%20vuelos."
            target="_blank"
        ...
        <div className="offer-strip__grid">
          {offers.map((o, i) => (
            <motion.a
              ...
              href={`https://wa.me/18299952995?text=${encodeURIComponent(`Hola! Me interesa un vuelo a ${o.route} por ${o.price}`)}`}
              target="_blank"
              rel="noopener noreferrer"
