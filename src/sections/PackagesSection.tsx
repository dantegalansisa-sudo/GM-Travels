    ...
    <section className="resorts" id="resorts" ref={ref}>
      <div className="resorts__layout">
        ...
        <div className="resorts__content-side">
          ...
          >
            {items.map((item, i) => (
              <motion.a
                ...
                key={item.resort}
                variants={fadeInUp}
                href={`https://wa.me/18299952995?text=${encodeURIComponent(`Hola! Me interesa la oferta del resort ${item.resort} (${item.price})`)}`}
                target="_blank"
          ...
          <MagneticButton
            href="https://wa.me/18299952995?text=Hola!%20Quiero%20información%20sobre%20las%20ofertas%20de%20resorts."
