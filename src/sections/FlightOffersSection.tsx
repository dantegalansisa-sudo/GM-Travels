          ...
          >
            {flights.map((f) => (
              <motion.div className="flight-row" key={f.to} variants={fadeInUp}>
                ...
                <MagneticButton
                  href={`https://wa.me/18299952995?text=${encodeURIComponent(`Hola! Me interesa un vuelo a ${f.city} por ${f.price}`)}`}
          ...
          >
            {hotelesNacionales.map((h) => (
              <motion.div className="flight-row hotel-row" key={h.name} variants={fadeInUp}>
                ...
                <MagneticButton
                  href={`https://wa.me/18299952995?text=${encodeURIComponent(`Hola! Me interesa el hotel ${h.name} en ${h.city}`)}`}
                  className="flight-row__cta"
                  target="_blank"
                >
                  Cotizar
