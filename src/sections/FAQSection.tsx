...
const fallbackFaqs = [
  {
    ...
    a: 'Usa nuestro buscador de vuelos en la portada o escríbenos directamente por WhatsApp al 829-995-2995. Te enviamos la cotización en menos de 5 minutos y puedes reservar con solo RD$2,000.',
  },
  {
