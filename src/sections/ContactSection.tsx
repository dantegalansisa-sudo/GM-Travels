...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/18299952995?text=${encodeURIComponent(text)}`, '_blank');
  };
            ...
            <div className="contact__details">
              <div className="contact__detail">
                ...
                <div>
                  ...
                  <a href="https://wa.me/18299952995" target="_blank" rel="noopener noreferrer">829-995-2995</a>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📍</span>
                <div>
                  ...
                  <span>Calle Palermo 14, Urbanización Italia, Edificio Gomed, Santo Domingo</span>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📷</span>
                <div>
                  ...
                  <a href="https://instagram.com/gmtravelss" target="_blank" rel="noopener noreferrer">@gmtravelss</a>
                </div>
              </div>
            </div>
