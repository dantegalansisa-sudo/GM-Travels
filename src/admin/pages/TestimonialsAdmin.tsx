    ...
    <div>
      ...
      {showModal && (
        <div className="adm-overlay" onClick={close}><div className="adm-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="adm-form-row adm-form-row--full"><div className="adm-field"><label>Texto</label><textarea value={form.text} onChange={e => setForm({ ...form, text: e.target.value })} placeholder="Me consiguieron el vuelo más barato..." /></div></div>
