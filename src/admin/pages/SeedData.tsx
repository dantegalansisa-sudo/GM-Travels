...
const faqs = [
  { question: '¿Cómo puedo reservar un vuelo?', answer: 'Usa nuestro buscador de vuelos en la portada o escríbenos directamente por WhatsApp al 829-995-2995. Te enviamos la cotización en menos de 5 minutos y puedes reservar con solo RD$2,000.', order: 0, active: true },
...
const teamMembers = [
  { name: 'Jesús de la Cruz Disla', role: 'Presidente', bio: 'Empresario y líder estratégico de la agencia. Dirige con visión el crecimiento de la agencia y la expansión de destinos.', imageUrl: '', instagram: '@gmtravelss', isLeadership: true, leadershipGroupImage: '/imagenes/presidente-vicepresidenta.jpeg', order: 0, active: true },
  { name: 'Maridania Gerbacio', role: 'Vicepresidenta', bio: 'Mercadóloga y líder organizacional de la agencia. Se destaca por su liderazgo en la optimización de procesos.', imageUrl: '', instagram: '@gmtravelss', isLeadership: true, leadershipGroupImage: '/imagenes/presidente-vicepresidenta.jpeg', order: 1, active: true },
  { name: 'Yudelka Mejía', role: 'Encargada de Operaciones', bio: 'Pilar fundamental en el día a día de la agencia, se encarga de la atención personalizada a cada cliente.', imageUrl: '/imagenes/encargada.jpeg', instagram: '@gmtravelss', isLeadership: false, leadershipGroupImage: null, order: 2, active: true },
];
...
const contactConfig = {
  whatsappPrimary: '18299952995', whatsappSecondary: '18296697762',
  email: 'mjtravel.srl@hotmail.com',
  address: 'Calle Palermo 14, Urbanización Italia, Edificio Gomed, Santo Domingo',
  instagram: '@gmtravelss',
};
